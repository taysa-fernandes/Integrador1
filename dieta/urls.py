...
from  dieta.views import VerDieta, CadastrarDieta, ListarDietas, EditarDieta, DeletarDieta, DefinirNumeroRefeicoes
...
urlpatterns = [
    ...
    path('ver-dieta/', VerDieta.as_view(), name='ver-dieta'),
